...
$pay_sql   = "SELECT * FROM pub_payroll WHERE employee_id = ?";
...
$pdf->SetAuthor('PUB EXPRESS RESTO');
...
$pdf->Image('images/Pub.png', 10, 12, 30, 0, 'PNG'); 

$pdf->SetFont('helvetica', 'B', 14);
$pdf->Cell(0, 10, 'PUB EXPRESS RESTO', 0, 1, 'C');
$pdf->SetFont('helvetica', '', 10);
$pdf->Cell(0, 6, 'Annex Sm City Mandurriao, Iloilo City', 0, 1, 'C');
$pdf->Cell(0, 6, 'Email: pubexpresss@gmail.com', 0, 1, 'C');
