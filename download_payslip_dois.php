...
$pdf->Image('images/DOIS.png', 10, 12, 30, 0, 'PNG'); 

$pdf->SetFont('helvetica', 'B', 14);
$pdf->Cell(0, 10, 'DOIS', 0, 1, 'C');
$pdf->SetFont('helvetica', '', 10);
$pdf->Cell(0, 6, 'Owned and Managed by: MERITONI CORP.', 0, 1, 'C');
$pdf->Cell(0, 6, 'Mac Arthur Drive, Tabuc Suba', 0, 1, 'C');
$pdf->Cell(0, 6, 'Jaro, Iloilo City', 0, 1, 'C');
$pdf->Cell(0, 6, 'Tel No.: (033)501-2981', 0, 1, 'C');
...
$pdf->Ln(-10);
$pdf->Cell(105, 0, '__________________________', 0, 0);
$pdf->Cell(70, 0, '__________________________', 0, 1);
$pdf->Ln(-10);
